...
import com.genc.project.entities.AuthRequest;
import com.genc.project.entities.Course;
import com.genc.project.entities.PasswordChangeRequest;
...
public class AuthController {
    ...
    public ResponseEntity<String> changePassword(@RequestBody PasswordChangeRequest request, Authentication auth) {
        ...
        System.out.println("Haiiiiiiiiiiiiiiiiiiiiiiiiiii*************"+"     "+user.getPassword());
